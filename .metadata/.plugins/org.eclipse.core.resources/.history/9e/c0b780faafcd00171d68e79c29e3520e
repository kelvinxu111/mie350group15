	...
	public static Connection getConnection() {
		if (connection != null)
			...
			try {
				...
				connection = DriverManager.getConnection("jdbc:ucanaccess://C:/Users/Kelvin/Documents/GitHub/mie350group15/mie350_group15/src/dbmie350_group15.mdb;memory=false"); 
